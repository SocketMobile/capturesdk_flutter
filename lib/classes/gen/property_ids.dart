...
class CapturePropertyIds {
	...
	/// Device: True	Get Type: None 	Set Type: NotApplicable
	static const int buttonsStatusDevice = 65792;
...
class Trigger {
	...
	static const int continuousScanUntilRead = 6;
