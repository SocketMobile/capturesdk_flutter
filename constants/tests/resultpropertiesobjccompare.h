...
/**
  define the properties used by Capture.
*/
typedef NS_ENUM(NSInteger, SKTCapturePropertyID) {
	...
	*/
	...
	Device: False	Get Type: None 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingProfile = -2147155959,
	...
	Device: False	Get Type: None 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingCurrentProfile = -2147155958,
	...
	Device: False	Get Type: String 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingTriggerSymbologies = -2141913077,
	...
	Device: False	Get Type: String 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingTriggerMinLength = -2141913076,
	...
	Device: False	Get Type: String 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingTriggerMaxLength = -2141913075,
	...
	Device: False	Get Type: String 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingTriggerStartsBy = -2141913074,
	...
	Device: False	Get Type: String 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingTriggerEndsWith = -2141913073,
	...
	Device: False	Get Type: String 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingTriggerContains = -2141913072,
	...
	Device: False	Get Type: String 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingOperation = -2141913071,
	...
	Device: False	Get Type: String 	Set Type: String
	*/
	SKTCapturePropertyIDDataEditingImportExport = -2141913070,
