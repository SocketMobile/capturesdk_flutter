...
class SktErrors {
  ...
  static const int ESKT_CONFLICTPROFILE = -80;

  /// The current profile cannot be deleted
  /// THIS ERROR IS DEPRECATED!!!
  static const int ESKT_DELETECURRENTPROFILE = -81;

  /// Data editing cannot be initialized
  /// THIS ERROR IS DEPRECATED!!!
  static const int ESKT_UNABLEINITIALIZEDATAEDITING = -82;

  /// The data editing operation is invalid
  /// THIS ERROR IS DEPRECATED!!!
  static const int ESKT_UNKNOWNDATAEDITINGOPERATION = -83;
